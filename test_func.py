...
def main():
    ...
    with open("/proj/snic2022-22-1035/1205/stockhamFFT_cg_" + str(radix) + "_" + str(inputSize) + ".mlir", "w") as w:
        w.write(opted_mlir)
    codeGen = subprocess.run(["/proj/snic2022-22-1035/1205/llvm-project/build/bin/mlir-cpu-runner", "-e", "compute", "-entry-point-result=void", "-O3", "-dump-object-file", "-object-filename=/proj/snic2022-22-1035/1205/stockhamFFT_" + str(radix) + "_" + str(inputSize) +".o",  "/proj/snic2022-22-1035/1205/stockhamFFT_cg_" + str(radix) + "_" + str(inputSize) + ".mlir"], stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True) 
    after_cg = time.time()
